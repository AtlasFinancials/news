...
WORK = os.path.join(ROOT, "morning/2026/04/audio_work_17")
FINAL = os.path.join(ROOT, "morning/2026/04/17.mp3")
JSON_OUT = os.path.join(ROOT, "morning/2026/04/17-chapters.json")
